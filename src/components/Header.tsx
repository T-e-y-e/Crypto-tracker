...
const Header = ({currency, setCurrency, setSymbol}: Props) => {
  return (
   <div>
<nav className="bg-slate-900 sm:px-4 dark:bg-gray-900">
  ...
  <Link to="/" className="flex items-center">
      <span className="self-center flex items-center text-3xl text-slate-100  whitespace-nowrap dark:text-white">
       <img src={ require("../assets/brand-logo.svg").default } alt="" className='navbar-brand w-12'/>
        <span className='text-white ml-1 brand'>
          CryptIn
        </span>
       </span>
  </Link>
  ...
  <div className="justify-between flex items-center">
    <ul className="flex">
    <li>
        <NavLink to="/" className="nav-link flex items-baseline pt-4 pb-3 mr-10 text-white text-lg font-semibold hover:text-slate-200 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
          <img src={ require("../assets/house-solid.svg").default } alt="" className='navbar-brand w-6'/>
          <span className='pl-2'>Home</span>
        </NavLink>
      </li>
      <li>
      <NavLink to="/trending" className="nav-link flex items-baseline pt-4 pb-3 ml-3 text-white text-lg font-semibold hover:text-slate-200 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700">
